...
public class PoissonSolver extends ODESolver {

	private static final double ERR_TOLERANCE = 1E-6;
	...
	public Function[] solve() {
		final int n = domain.getNumPoints();
		...
		return new Function[] {new GreedyFunction(domain, soln)};
	}
	...
	private double stencil(int i, double[] vals) {
		final double oldVal = vals[i], dx = domain.getDx(), x = domain.getValAtIndex(i), 
